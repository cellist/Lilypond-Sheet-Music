...
%  \set Timing.beatStructure  = #'(1 1 1)
  \tempo "1. Allegro con grazia " 4=110
}
   ...
   \paper {
    ...
    oddFooterMarkup = \markup {
      \fill-line {
        ...
        "Giuseppe Maria Cambini - Allegro con grazia" \fromproperty #'page:page-number-string
      }
    }
