vc = \relative c {
   ...
   \repeat volta 2 {
     ...
     d' d, cis d a'[ a16 h] cis8 a
     d d, cis d a'8.[( d,16) a'8.( d,16)]
     a'8 a, cis e a e cis a
     d h e e, a4.
   }

   \repeat volta 2 {
     \partial 8 a8
     a'4 r8 d, a'[ a,16 h] cis8 d
     a' a,16 h cis8[ d] a'8 a16 h cis8[ a]
     d d, h g d' d' h g

     d' d, h g d'[ d16 e] fis8 d
     g d h cis d fis a d
     e, fis16 g a8[ a,] d4. fis8

     a a, a' cis d fis, fis h
     e, a a g fis a d d,
     g g, d' fis e d cis a
     d g a a, <d, a'>4.
   }
