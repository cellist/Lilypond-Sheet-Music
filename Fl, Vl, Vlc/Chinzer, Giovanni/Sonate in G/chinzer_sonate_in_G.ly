...
\header {
  ...
  piece     = "6 Trio-Sonaten; Nr. 3 (IGC 2)"
}
   ...
   \paper {
    ...
    oddFooterMarkup = \markup {
      \fill-line {
        ...
        "Giovanni Chinzer - Sonate in G-Dur" \fromproperty #'page:page-number-string
      }
    }
